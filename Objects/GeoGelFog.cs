...
namespace ReikaKalseki.SeaToSea {
	...
	public class GeoGelFog : Spawnable {
	    ...
	    public override GameObject GetGameObject() {
			...
			ObjectUtil.removeComponent<UWE.TriggerStayTracker>(world);
			ObjectUtil.removeComponent<FMOD_StudioEventEmitter>(world);
			ObjectUtil.removeComponent<FMOD_CustomEmitter>(world);
			ObjectUtil.removeChildObject(world, "xflash");
