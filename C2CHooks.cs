	...
	public static class C2CHooks {
	    ...
	    public static void tickPlayer(Player ep) {
	    	...
	    	if (UnityEngine.Random.Range(0, (int)(10/Time.timeScale)) == 0 && ep.currentSub == null) {
	    		...
	    		if (SeaToSeaMod.config.getBoolean(C2CConfig.ConfigEntries.PROMPTS) && Player.main.IsSwimming() && MathUtil.isPointInCylinder(dronePDACaveEntrance.setY(-40), ep.transform.position, 80, 40)) {
