...
namespace ReikaKalseki.SeaToSea {
	public sealed class VoidSpikeWreck : WorldGenerator {
		...
		private GameObject generateObjectInRange(Vector3 refPos, float r, VoidWreckProp p) {
			...
			return this.generateObjectInRange(refPos, r, p.prefab.baseTemplate.prefab.StartsWith("e600", StringComparison.InvariantCultureIgnoreCase) ? p.prefab.baseTemplate.prefab : p.prefab.ClassID, p.yOffset, tilt);
		}
