...
namespace ReikaKalseki.SeaToSea {
	...
	public class AlkaliPlant : BasicCustomPlant {
		...
		public AlkaliPlant() : base(SeaToSeaMod.itemLocale.getEntry("ALKALI_PLANT"), new FloraPrefabFetch(VanillaFlora.REDWORT), "daff0e31-dd08-4219-8793-39547fdb745e", "Samples") {
			glowIntensity = 2;
			finalCutBonus = 0;
