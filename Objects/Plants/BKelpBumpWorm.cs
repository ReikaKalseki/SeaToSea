...
namespace ReikaKalseki.SeaToSea {
	...
	public class BKelpBumpWorm : Spawnable {
	    ...
	    public override GameObject GetGameObject() {
			...
			ObjectUtil.removeComponent<SpikePlant>(go);
			ObjectUtil.removeComponent<LiveMixin>(go);
			ObjectUtil.removeComponent<RangeAttacker>(go);
			ObjectUtil.removeComponent<RangeTargeter>(go);
			ObjectUtil.removeComponent<RangedAttackLastTarget>(go);
			ObjectUtil.removeComponent<AttackLastTarget>(go);
