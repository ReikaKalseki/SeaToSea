	...
	public static class C2CRecipes {
		...
		internal static void addItemsAndRecipes() {
            ...
            */
			...
			C2CItems.oxygeniteCharge.addIngredient(TechType.Tank, 1).addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.OXYGENITE), 4).addIngredient(TechType.Pipe, 5).addIngredient(microfilter, 1);
